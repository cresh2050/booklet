 ...
 */
(function(a){a.fn.booklet=function(k,f,d){var i,c,h,g,l,e,j;if(typeof k==="string")
{
l=new Array();a(this).each(function(){i=a(this).data("booklet");
if(i){c=k;h=new Array();
if(f){h.push(f)}if(d){h.push(d)}if(i[c]){g=i[c].apply(i,h);
if(typeof g!=="undefined"||g){l.push(i[c].apply(i,h))}}else{a.error('Method "'+c+'" does not exist on jQuery.booklet.')
}}else
